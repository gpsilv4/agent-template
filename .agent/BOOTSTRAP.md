...
- **`.agent/context/backlog-template.md`** e **`backlog-template-archive.md`**: **APAGAR**. Rastreiam o trabalho sobre o *template de origem* — nao pertencem ao teu projeto. (`rm .agent/context/backlog-template*.md`)
