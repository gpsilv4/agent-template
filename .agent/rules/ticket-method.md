...
**Primeiro perguntar, depois explicar** (`L`, ou `M` ambiguo): correr
`.agent/workflows/grill.md` **antes** de escrever o plano — as "Decisoes fechadas" que saem
dele sao o input desta fase. Num `S` **nao corre**. (Porque: `src/docs/ticket-method-why.md`.)
